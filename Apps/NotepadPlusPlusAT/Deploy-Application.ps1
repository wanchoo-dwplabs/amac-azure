...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## SAMPLE: EXE
		$exeInstall = "Install.bat"
		$exeInstallParams = ""
		#Execute-Process -Path "$($dirFiles)\$($exeInstall)" -Parameters "$($exeInstallParams)" -WindowStyle 'Hidden'
		Execute-Process -Path "$($dirFiles)\$($exeInstall)" -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Write-log -Message "Uninstallation of the testing package $($appName) is not supported."
		<#
