...
Try {
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$AppList = Get-InstalledApplication -Name 'FileZilla Client'
		...
		$InstallPath = Join-Path -Path $env:ProgramFiles -ChildPath "FileZilla FTP Client"
        if (Test-Path -Path $InstallPath) {
        	Write-Log -Message "Cleanup FileZilla FTP Client Program Files Directory."
